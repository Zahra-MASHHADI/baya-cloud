        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center">
                    <div v-for="(avatar, index) in item.avatars.slice(0, 3)" :key="index" class="relative  flex items-center justify-center rounded-full border-2 border-neutral-100 dark:border-neutral-700 size-9" :class="[index !== 0 && `!-ms-4 z-[${index}]` , ` ${avatar.color}`]" >
                ...
                <div v-if="item.avatars.length > 3">
                    ...
                    <div
                        ...
                        class="flex justify-center !-ms-5 z-[4] items-center border-2 border-neutral-100 rounded-full shadow-md shadow-neutral-400 bg-neutral-200 dark:bg-neutral-700 size-9 relative "
                    >
            ...
            <div class="flex items-center gap-4">
                <!-- Avatars Stack -->
                <div class="flex items-center">
                    <div v-for="(avatar, index) in item.pictures.slice(0, 3)" :key="index" class="relative" :class="[index !== 0 && `!-ms-5 z-[${index}]`]" >
                        <img :src="avatar" :alt="`Avatar ${index + 1}`" class="size-10 rounded-full border-2 border-white object-cover " />
                    </div>
