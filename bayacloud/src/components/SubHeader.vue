...
<template>
      ...
      <div class="flex justify-end gap-3 mb-6 px-8">
        <!-- upload icon  -->
        <button
          class="flex items-center gap-2 px-6 py-2 border-2 border-cyan-500 text-gray-700 rounded-2xl hover:bg-gray-50 transition-colors"
        >
          <svg
        ...
        <button
          ...
          class="flex items-center gap-2 px-6 py-2 bg-cyan-500 text-white rounded-2xl hover:bg-cyan-600 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
